          ...
          <div className="flex items-center gap-x-[10px] rounded-lg bg-blue-600 px-6 py-4 text-white">
            ...
            <div>
              ...
              isConnectedToPeraWallet ? (
                <div>
                  <Link href={"/history"} className="mr-2 hover:text-blue-400">
                    History
                  </Link>
                  <b className="ml-2">|</b>
              ...
              <div className="grid grid-cols-2 gap-1">
                {wallet.connected ? (
                  ...
                  <button
                    className="bg-white text-blue-700 hover:text-blue-900 focus:outline-none font-medium rounded-lg px-2.5 py-0.5 text-center"
                    onClick={onOpen}
                  >
                    Connect Wallet
                  </button>
                ...
                >
                  <Dropdown>
                    ...
                    >
                      ...
                      <DropdownItem
                        key="arbitrumtestnet"
                        startContent={<ArbitrumIcon className={iconClasses} />}
                        onClick={() =>
                          setSelectedKeys(
                            <>
